/*
  ...
  - You are about to alter the column `cep` on the `Customer` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Integer`.

*/
-- AlterTable
ALTER TABLE "Customer" ALTER COLUMN "cpf" SET DATA TYPE INTEGER,
